...
import com.quane.little.language.{Expression, FunctionParameter, FunctionReference}
...
class FunctionReferencePresenter(val view: FunctionReferenceView,
  ...
  private[presenter] def add(param: FunctionParameter, value: Expression): Unit = {
