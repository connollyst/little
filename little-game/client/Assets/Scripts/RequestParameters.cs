...
namespace PreviewLabs
{
		...
		{
				public string testParameters = "?ide_id=debug&company=PreviewLabs";
				...
				public void SetRequestParameters (string parametersString)
				{
						...
						for (int i=0; i<parameters.Length; ++i) {
								...
								if (RequestParameters.parameters.ContainsKey (keyValue [0])) {
										Debug.Log ("Skipping existing parameter '" + keyValue [0] + "'.");
